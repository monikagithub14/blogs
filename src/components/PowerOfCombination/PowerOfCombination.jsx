      ...
      <section className='relative flex items-center justify-center min-h-[60vh] md:min-h-screen w-full bg-[url("./perfume4.png")] bg-cover bg-center px-6'>
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <motion.h1
            ...
            viewport={{ once: true }}
            className="tracking-normal text-3xl md:text-3xl lg:text-[50px] sm:text-xl font-semibold font-montserrat uppercase leading-tight"
          >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className=" mt-6 italic font-[Poppins] text-base md:text-xl lg:text-[20px] font-normal leading-relaxed"
          >
      ...
      <section className="py-16 md:py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto mb-12">
          <motion.p
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true }}
            className="italic font-[Poppins] text-lg md:text-xl lg:text-[15px] font-light text-gray-700 leading-relaxed"
          >
        ...
        <div className="relative flex items-center justify-center md:py-10 py-5 scale-90 sm:scale-100 md:gap-12 gap-10">
          <div className="flex items-center justify-center w-48 h-48 border border-gray-300 rounded-full sm:w-[360px] sm:h-[360px] mix-blend-multiply">
            <span className="text-xs sm:text-lg lg:text-[20px] font-medium tracking-[0.1em] uppercase ">
              Wisdom
            </span>
          </div>
        ...
        <div className="mt-12 group cursor-pointer inline-flex flex-col items-start">
          <button className="font-poppins tracking-normal text-base md:text-[20px] font-medium transition-colors hover:text-gray-600">
            Sovereign stillness{" "}
            <FaAngleRight
              className="sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 inline  md:text-[20px] font-medium"
            />
          </button>
          <div className="h-[3px] w-5 mt-1 rounded-full bg-black "></div>
        </div>
      </section>
      ...
      <section className="relative z-10 bg-white py-16 md:py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto mb-12">
          <motion.p
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true }}
            className=" w-full italic font-[Poppins] text-lg md:text-xl lg:text-[15px] font-light text-gray-700 leading-relaxed"
          >
            Perfection refines the inner gesture. Harmony allows it to
            flownaturally,<br /> beautifully, without excess.
          </motion.p>
        </div>
        ...
        <div className="relative flex items-center justify-center md:py-10 py-5 scale-90 sm:scale-100 md:gap-12 gap-10">
          <div className="flex items-center justify-center w-48 h-48 border border-gray-300 rounded-full sm:w-[360px] sm:h-[360px] mix-blend-multiply">
            ...
            <span className="text-xs sm:text-lg lg:text-[20px] font-normal tracking-[0.1em] uppercase ">
              Perfection
            </span>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <motion.div className="p-1 sm:p-2 bg-white"
        ...
        <div className="mt-12 group cursor-pointer inline-flex flex-col items-start text-left">
          <button className="font-[Poppins] text-base md:text-[20px] font-medium transition-colors hover:text-gray-600">
            Grace in alignment{" "}
            <FaAngleRight
              size={12}
      ...
      <section className="relative z-10 bg-white my-10 md:my-0 py-10 md:py-24 px-6 text-center">
        ...
        <div className="relative flex items-center justify-center sm:my-24  scale-75 sm:scale-100 min-h-[500px] sm:min-h-[650px]">
          ...
          <div className="absolute flex items-center justify-center w-56 h-56 border border-gray-300 rounded-full sm:w-80 sm:h-80 mix-blend-multiply -translate-y-28 sm:-translate-y-40">
            <span className="text-xs sm:text-lg lg:text-[20px] font-normal tracking-[0.1em] uppercase -translate-y-6">
          ...
          {/* STRENGTH */}
          <div className="absolute flex items-center justify-center w-56 h-56 border border-gray-300 rounded-full sm:w-80 sm:h-80 mix-blend-multiply translate-x-28 sm:translate-x-40">
            <span className="text-xs sm:text-lg lg:text-[20px] font-normal tracking-[0.1em] uppercase translate-x-6">
              Strength
            </span>
          </div>
        </div>
      ...
      <div className="relative z-10 bg-white text-center py-28">
        <div>
          <motion.p
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true }}
            className="font-medium  text-xl md:text-2xl lg:text-[30px] font-[Montserrat] uppercase tracking-normal leading-7 md:leading-10"
          >
        ...
        <div className="md:my-4 my-20 flex items-center justify-center w-full md:min-h-[600px] bg-white p-4 md:p-5">
          <div className="relative flex items-center justify-center w-[150px] h-[150px] sm:w-[300px] sm:h-[300px] md:w-[350px] md:h-[350px]">
            ...
            <div className="absolute top-0 -translate-y-[60%] flex flex-col items-center">
              <span className="mb-3 text-xs sm:text-lg lg:text-[20px] font-normal capitalize text-black">
                Wisdom
              </span>
            ...
            <div className="absolute bottom-0 translate-y-[60%] flex flex-col items-center">
              <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white border border-gray-400 rounded-full shadow-sm"></div>
              <span className="mt-3 text-xs sm:text-lg lg:text-[20px] font-normal capitalize text-black">
                Harmony
              </span>
            </div>
            ...
            <div className="absolute left-0 -translate-x-[85%] flex items-center">
              <div className="flex flex-col items-end mr-3">
                <span className="text-sm  sm:text-base md:text-lg lg:text-[20px] font-medium capitalize text-black">
                  Perfection
                </span>
              </div>
              <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white border border-gray-400 rounded-full shadow-sm"></div>
